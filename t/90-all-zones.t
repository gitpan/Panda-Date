...
plan skip_all => 'set TEST_FULL=1 to enable real all zones test' unless $ENV{TEST_FULL};
...
# in our time periods
my %buggy_zones = map {$_ => 1} @{
    {
        'freebsd' => [qw# America/Anchorage Australia/Lord_Howe America/Scoresbysund America/Nome Asia/Choibalsan 
                          Asia/Ust-Nera #],
    }->{$^O}
};
